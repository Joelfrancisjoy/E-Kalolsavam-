...
from .views import (
    ...
    PublishedEventsView, toggle_event_publish,
...
urlpatterns = [
    ...
    path('<int:pk>/toggle-publish/', toggle_event_publish, name='event-toggle-publish'),
    ...
    path('<int:pk>/participants/', ParticipantsByEventForJudgeView.as_view(), name='event-participants-for-judge'),
    # Volunteer helpers
    path('participant-verifications/', ParticipantVerificationView.as_view(), name='participant-verifications'),
    path('verify-participant/', verify_participant_by_chess_number, name='verify-participant'),
    path('volunteer-assignments/', get_volunteer_assignments, name='volunteer-assignments'),
    path('volunteer-check-in/', volunteer_check_in, name='volunteer-check-in'),
    path('<int:pk>/assign-volunteers/', assign_volunteers, name='assign-volunteers'),
]